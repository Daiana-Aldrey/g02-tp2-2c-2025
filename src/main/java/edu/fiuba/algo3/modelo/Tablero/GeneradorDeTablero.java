...
public class GeneradorDeTablero {
    ...
    public List<Puerto> generarPuertos() {
        ...
        puertos.add(new PuertoEspecifico(new Mineral(), new UbicacionVertice(51), new UbicacionVertice(52)));
        puertos.add(new PuertoEspecifico(new Ladrillo(), new UbicacionVertice(46), new UbicacionVertice(47)));
        puertos.add(new PuertoEspecifico(new Lana(), new UbicacionVertice(15), new UbicacionVertice(16)));
